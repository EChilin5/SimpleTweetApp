...
The challenges that I faced were implementing the Dao file as I mistyped a few parts of SQL code. As well trying to implement the floating
button as I was trying to click it with out clicking on the activity itself. Instead of taking me to the specified compose activity it took me 
to the detail activity (Can be scene in the video for the first part of this project). I also had an issue with github because I did not remove 
the commits with the large video files from part 1. I had to use rebase and delete the previous commits in order to upload then new changes to github
properly.  
